                          ...
                          <div className="add_question_body">
                            ...
                            <div className="add_footer">
                                <div className="add_question_bottom_left">
                                    ...
                                    <Button size="small"  style={{ textTransform: 'none', color: "#4285f4", fontSize: "13px", fontWeight: "600" }}><LaunchOutlinedIcon style={{ padding: "2px", marginRight: "8px"}}/> Answer key</Button>
